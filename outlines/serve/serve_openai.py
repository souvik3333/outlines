...
async def generate(request: OutlinesChatCompletionRequest, raw_request: Request) -> Response:
    """Generate completion for the request.

    The request should be a JSON object with the following fields:
    - messages: messages to use for prompt generation.
    ...
    add_generation_prompt = request_dict.pop("add_generation_prompt")
    ...
    try:
        ...
        err = ErrorResponse(message=str(e), type="BadRequestError", code=HTTPStatus.BAD_REQUEST)
